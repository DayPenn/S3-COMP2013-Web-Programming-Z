// Lab 1 - Dayna Pennock - due Friday, September 12, 2025
...
// Lab 1 - Dayna Pennock - due Friday, September 12, 2025
// ARRAY NAME (to save scrolling)... const listings = [
...
let realtorFees = (listing1.price <= 450000) ?/*if true*/ listing1.price * 0.025 :/*else*/ listing1.price * 0.02;

console.log(realtorFees); // getting NaN on Quokka for this but not sure why...
console.log(listing1.price); // troubleshooting: SHOWS PROPER PRICE

// After getting same issue with Q#6, thinking I'm having issues b/c price is in quotations???
...
const newBuiltListings = listings.filter((listings)=> listings.builtIn >= 1990);

console.log(newBuiltListings); 
/* Quokka not showing anything in [] but I assume it's 
because there are quotations around builtIn #s and the 
system thinks it's a string and not comparing it to 2019 
I used your student sort (tuition) example for this 

the answer to this problem is beyond my experience level */